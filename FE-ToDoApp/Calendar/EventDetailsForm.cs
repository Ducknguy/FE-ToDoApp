...
namespace FE_ToDoApp.Calendar
{
    public class EventDetailsForm : Form
    {
        ...
        private void RenderList(List<TaskItem> events)
        {
            ...
            var sortedEvents = events.OrderBy(t => t.DueDate).ToList();
        ...
        private void ReloadData()
        {
            ...
            var tasksForDay = allTasks.Where(t => t.DueDate.Date == _currentDate.Date).ToList();
        ...
        private Panel CreateEventItem(TaskItem task)
        {
            ...
            // Giờ
            Label lblTime = new Label() { Text = task.DueDate.ToString("HH:mm"), Location = new Point(10, 15), Size = new Size(60, 25), Font = new Font("Segoe UI", 11, FontStyle.Bold), ForeColor = Color.OrangeRed };
