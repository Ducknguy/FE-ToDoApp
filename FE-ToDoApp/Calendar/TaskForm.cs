...
namespace FE_ToDoApp.Calendar
{
    public class TaskForm : Form
    {
        ...
        public TaskForm(DateTime date, TaskItem taskToEdit)
        {
            ...
            dtpTime.Value = isEditMode ? _currentTask.StartDate : new DateTime(date.Year, date.Month, date.Day, DateTime.Now.Hour, DateTime.Now.Minute, 0);
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                TaskItem newTask = new TaskItem() { Title = txtTitle.Text, Description = txtDesc.Text, StartDate = newStart, Status = "New" };
